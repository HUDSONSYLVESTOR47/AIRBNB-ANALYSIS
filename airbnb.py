...
st.set_page_config(page_title="AirBnb-Analysis by HUDSON SYLVESTOR A", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    #os.chdir("Data.csv")
    df = pd.read_csv(r"C:/Users/31syl/Desktop/dataharvesting/Data.csv", encoding="ISO-8859-1")
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"HUDSON SYLVESTOR A"}')
    mail = (f'{"Mail :"}  {"31sylvestor01@gmail.com"}')
    Batch = (f'{"Batch Code :"}  {"DW73DW74"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {

        "GITHUB": "https://github.com/HUDSONSYLVESTOR47",
        "LINKEDIN": "https://www.linkedin.com/in/hudsonsylvestor"
        
        }

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:/Users/31syl/Desktop/dataharvesting/airbnb_logo.jpg"), width=300)
    col1.image(Image.open("C:/Users/31syl/Desktop/dataharvesting/guvi_logo.jpg"), width=300)
    with col2:
        st.header('Airbnb Analysis')
        st.subheader(
